  ...
  return (
    <>
      <p>
        ...
        You'll make ___ (salary)/year as a ___ (occupation) after graduating
        from ___ (college). You'll have {kidsNumber} kids and a pet ___ named
        ___. You'll drive a {carColor} {carType}, and your family will vacation
        in ___ (destination) every year.
      </p>
      <button
        type="submit"
